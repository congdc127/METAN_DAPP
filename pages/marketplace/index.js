                    ...
                    <Col lg={3}>
                        <div className={`filter-table ${filterState}`}>
                            <div className="filter-header">
                                ...
                                <button
                                    className="btn btn-danger d-md-none btn-sm"
                                    onClick={() => {
                                        setFilterState('');
                                    }}
                                >
                                ...
                                <button className="btn btn-clear-filter d-none d-md-block">
                                    CLEAR FILTERS
                                </button>
                            </div>
                            <div className="filter-body">
                                ...
                                <button className="btn btn-clear-filter d-md-none w-100 mt-2">
                                    CLEAR FILTERS
                                </button>
                            </div>
                        </div>
